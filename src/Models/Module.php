...
class Module extends Model
{
    ...
    public static function insert($module_name, $request)
    {
        ...
        if(isset($module)) {
            ...
            foreach($uniqueFields as $field) {
                ...
                if(isset($old_row->id)) {                    DB::table($module->name_db)->whereNotNull('deleted_at')->where($field['colname'], $request->{$field['colname']})->delete();
                }
            }
    ...
    public static function updateRow($module_name, $request, $id)
    {
        ...
        if(isset($module)) {
            ...
            // Preenche o modelo com os valores atualizados
            //$row->fill($data);
            $row->save();
            return $row->id;
        } else {
