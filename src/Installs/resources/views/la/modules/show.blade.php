...
<td><?php echo LAHelper::parseValues($field['popup_vals']) ?></td>
			...
			<td style="min-width:60px;">
				...
				<a href="{{ url(config('laraadmin.adminRoute') . '/modules/'.$module->id.'/set_view_col/'.$field['colname']) }}" class="btn btn-block btn-success btn-sm" id="view_col_{{ $field['colname'] }}"><i class="fa fa-eye"></i></a>
				@endif
			</td>
		</tr>
		@endforeach
...
<div class="tab-pane fade" id="tab-access" role="tabpanel" aria-labelledby="tab-access">
<section class="content">
<div class="card">
<div class="card-body">
	<span class="pull-left">Permissões de acesso ao módulo por perfil</span>&nbsp;
	<i class="fa fa-circle gray"></i> Invisível &nbsp;
	<i class="fa fa-circle orange"></i> Apenas leitura &nbsp;
	<i class="fa fa-circle green"></i> Escrita/Edição &nbsp;
</div>
...
<div role="tabpanel" class="tab-pane fade" id="tab-sort"  aria-labelledby="tab-sort">
<section class="content">
<div class="card">
<div class="card-body">
...
<h4 class="modal-title">Deletar módulo</h4>
...
<div class="form-group">
<label for="listing_col">Exibir na lista principal: </label>
